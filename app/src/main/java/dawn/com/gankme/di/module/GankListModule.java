...
public class GankListModule {
    ...
    @FragmentScope
    @Provides
    GankListContract.View provideUserView() {
        return this.view;
    }

    @FragmentScope
    @Provides
    GankListContract.Model provideUserModel(GankListModel model) {
        return model;
    }
    ...
    @FragmentScope
    @Provides
    List<Daily> provideDailyList() {
        return new ArrayList<>();
    }

    @FragmentScope
    @Provides
    RecyclerView.Adapter provideDailyAdapter(List<Daily> list){
