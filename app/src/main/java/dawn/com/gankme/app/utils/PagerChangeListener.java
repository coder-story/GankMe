...
public class PagerChangeListener implements ViewPager.OnPageChangeListener {
    ...
    public static PagerChangeListener newInstance(Context context, CollapsingToolbarLayout collapsingToolbar, ImageView originImage, ImageView outgoingImage) {
        ImageAnimator imageAnimator = new ImageAnimator(context, collapsingToolbar, originImage, outgoingImage);
