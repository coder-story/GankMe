...
import dawn.com.gankme.mvp.ui.holder.DailyDetailItemHolder;
 ...
 * ================================================
 */
public class DailyDetailAdapter extends DefaultAdapter<Object> {

    private DailyDetailItemHolder holder;

    public DailyDetailAdapter(List<Object> infos) {
        super(infos);
    }

    @Override
    public BaseHolder<Object> getHolder(View v, int viewType) {
        holder = new DailyDetailItemHolder(v);
        return holder;
    }
