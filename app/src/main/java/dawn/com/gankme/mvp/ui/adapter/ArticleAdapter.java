...
import dawn.com.gankme.mvp.ui.holder.ArticleItemHolder;
...
public class ArticleAdapter extends DefaultAdapter<Article> {
    ...
    private ArticleItemHolder holder;
    ...
    @Override
    public BaseHolder<Article> getHolder(View v, int viewType) {
        holder = new ArticleItemHolder(v);
        return holder;
    }
