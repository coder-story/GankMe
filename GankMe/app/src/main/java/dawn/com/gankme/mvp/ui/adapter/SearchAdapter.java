...
import dawn.com.gankme.mvp.ui.holder.SearchItemHolder;
 ...
 * ================================================
 */
public class SearchAdapter extends DefaultAdapter<SearchResult> {
    public SearchAdapter(List<SearchResult> infos) {
        super(infos);
    }

    @Override
    public BaseHolder<SearchResult> getHolder(View v, int viewType) {
